    ...
    <body class="lh-copy sans-serif">
      <main class="pa4">
        <section class="measure-wide">
          ...
          <p>
            Unfortunately, someone decided to take advantage of our servers to mine Bitcoin. They were stealing the limited resources of a nonprofit for private gain.
          </p>
          <p>
